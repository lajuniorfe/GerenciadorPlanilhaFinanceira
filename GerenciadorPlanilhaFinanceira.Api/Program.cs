...
builder.Services.AddSingleton<IRabbitConsumerApp, RabbitConsumerApp>();
builder.Services.AddSingleton<IRabbitMq, RabbitMq>();
builder.Services.AddSingleton<IEnviarEmailServico, EnviarEmailServico>();
builder.Services.AddSingleton<IPlanilhaFinanceiroServico, PlanilhaFinanceiroServico>();
builder.Services.AddSingleton<IGerenciamentoAppServico, GerenciamentoPlanilhaAppServico>();
builder.Services.AddSingleton<IRabbitProducerApp, RabbitProducerApp>();
